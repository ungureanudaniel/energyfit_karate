...
class ContactForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            'author': forms.TextInput(attrs = {'class': 'form--control', 'placeholder': _('Full name...')}),
            ...
            'text': forms.TextInput(attrs= {'class': 'form--control', "style": "width:400px;",'placeholder': _('Your message...')}),
